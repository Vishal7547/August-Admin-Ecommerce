...
import {
  fetchHomeCollection,
  addInFocusImage,
  deletehomeInFocusImage,
  addInFocusVideo,
  deletehomeInFocusVideo,
                ...
                <div className="row mt-4 mb-5">
                  <div className="col-md-6">
                    <img
                      height={500}
                      width={500}
                      src={home?.inFocusPhoto?.url}
                      alt={home?.inFocusPhoto?.category}
                    />
