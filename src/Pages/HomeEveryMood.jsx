                ...
                <div className="row">
                  ...
                  <div className="col-md-9 mt-5">
                    ...
                    <div className="row mt-5 px-5">
                      <h1>Upload category for your every mood</h1>
                      <div className="row mt-2 w-75">
                        ...
                        <div className="mb-3">
                          ...
                          >
                            {everyMoodLoading ? "Loading..." : "Create Category"}
                          </button>
                        </div>
                      </div>
                    </div>
                        ...
                        home?.yourEveryMood?.map((c)=>(
                          ...
                          <div className="row mx-2">
                            <button className="btn btn-danger"
                             onClick={()=>dispatch(deleteYourEveryMood(c))}
                             disabled={everyMoodDeleteLoading}
                             >{everyMoodDeleteLoading?"Loading...":"Delete"}</button>
                          </div>
                        </div>
                        ))
                      }
